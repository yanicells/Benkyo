          ...
          <div className="border-t border-outline-variant/10">
            {!showVideo ? (
              <button
                ...
                className="w-full flex items-center gap-4 px-6 md:px-8 py-4 md:py-5 text-left hover:bg-surface-low transition-colors group"
              >
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#ff0000]/10 group-hover:bg-[#ff0000]/15 transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm md:text-base font-semibold text-foreground">Watch lesson guide</p>
                  <p className="text-xs text-on-surface-variant mt-0.5">Optional video walkthrough before drilling</p>
                </div>
              ...
              <div>
                <button
                  ...
                  className="w-full flex items-center gap-2 px-6 md:px-8 py-4 text-left hover:bg-surface-low transition-colors"
                >
                  <svg className="w-5 h-5 text-on-surface-variant" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 15l7-7 7 7" />
                  </svg>
                  <span className="text-sm text-on-surface-variant">Hide video</span>
                </button>
