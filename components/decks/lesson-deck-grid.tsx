...
function LessonCard({ lesson, index }: { lesson: Lesson, index: number }) {
  ...
  return (
    <Link href={`/decks/${lesson.id}`} className="relative group overflow-hidden rounded-[1.5rem] bg-surface-lowest p-6 shadow-[0_4px_20px_rgba(0,14,33,0.03)] transition duration-300 hover:-translate-y-1 hover:shadow-md cursor-pointer">
  ...
  return (
    <div className="flex flex-col gap-8 lg:gap-10 max-w-screen-xl mx-auto w-full pb-16">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6">
        ...
        {/* Grammar Block */}
        <Link href="/decks" className="lg:col-span-4 bg-surface-lowest rounded-[2rem] p-8 lg:p-10 shadow-[0_12px_40px_rgba(0,14,33,0.06)] hover:-translate-y-1 hover:shadow-lg transition-all duration-300 relative overflow-hidden group flex flex-col justify-between">
