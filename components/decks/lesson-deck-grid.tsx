    ...
    <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      {lessons.map((lesson) => (
        <Link
          ...
          className="group overflow-hidden rounded-3xl border border-slate-300 bg-white p-5 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-slate-500 hover:shadow-md"
        >
