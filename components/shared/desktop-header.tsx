    ...
    <header className="w-full h-20 px-8 flex items-center justify-between sticky top-0 z-30 bg-surface/80 backdrop-blur-md">
      ...
      <div className="flex-1 max-w-md relative">
        ...
        <input
          ...
          className="w-full bg-surface-low border-none rounded-xl py-2.5 pl-11 pr-4 text-sm text-foreground outline-none placeholder:text-on-surface-variant/70 font-semibold cursor-not-allowed"
        />
      </div>
      ...
      <div className="flex items-center gap-6 ml-8">
        ...
        <div className="flex items-center gap-4 text-on-surface-variant">
           <button title="Notifications coming soon" aria-disabled="true" className="opacity-50 cursor-not-allowed">
           ...
           <button title="Settings coming soon" aria-disabled="true" className="opacity-50 cursor-not-allowed">
              <svg className="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
