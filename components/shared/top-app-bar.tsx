        ...
        <div className="fixed inset-0 z-50 flex">
          ...
          <div className="relative w-72 max-w-[85vw] bg-surface-lowest h-full shadow-2xl flex flex-col">
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-outline-variant/10">
              <span className="font-display text-lg font-bold text-primary">Benkyo</span>
              <button
                type="button"
                onClick={() => setMenuOpen(false)}
            ...
            <div className="px-4 py-3 border-b border-outline-variant/10">
              {isSignedIn && user ? (
                ...
                >
                  {user.image ? (
                    // eslint-disable-next-line @next/next/no-img-element
                    <img src={user.image} alt={user.name} className="h-10 w-10 rounded-full ring-2 ring-primary/20" />
                  ) : (
                ...
                >
                  ...
                  Sign in with Google
                  <span className="ml-auto text-[10px] text-on-surface-variant">Sync progress</span>
                </button>
              )}
            </div>
