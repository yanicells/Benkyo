        ...
        {items.map((item) => {
          ...
          return (
            <Link
              key={item.name}
              href={item.href}
              className={`flex flex-col items-center justify-center w-full min-w-[60px] hover:text-primary transition-colors ${
            ...
            >
              ...
              <span className={`text-[9px] font-semibold tracking-wide ${isActive ? "opacity-100" : "opacity-80"}`}>
                {item.name}
              </span>
            </Link>
          );
